...
const Navigation = ({ isCatOpen, setIsCatOpen }) => (
...
const CartContent = ({
  cartItems, subtotal, shippingCost, total, couponCode, setCouponCode,
...
const CartActions = ({ couponCode, setCouponCode, clearCart, applyCoupon }) => (
  <div className="p-8 bg-blue-50/50 flex flex-col md:flex-row justify-between items-center gap-4">
    <form onSubmit={applyCoupon} className="flex bg-white rounded-full p-1 shadow-sm w-full md:w-96 border border-blue-100">
      <input 
        type="text" 
        value={couponCode}
